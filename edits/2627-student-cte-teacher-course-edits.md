...
Source: https://www.fldoe.org/file/20909/2627vtc.pdf
Manual: Student Database 2026-2027

This document covers 22 edits across three categories: Reject Rules (record rejected), State Validation (cross-format matching), and Exception Reports (advisory, does not reject). Edit numbering is non-sequential; Reject Rules run 1-9, 13-16, 19-20, 22-23, 40, 42-43 (gaps at 10-12, 17-18, 21, 24-39, 41), State Validation is 60, Exception Reports is 61.
...
### 5. Course Number must be a valid course number
...
### 6. Section Number must not be all blank
...
### 7. Period Number must be numeric and not 9999
...
### 13. Florida Educators Certificate Number must be numeric
...
### 14. Transaction Code validity and existence match
...
### 16. Social Security Number numeric and left-justified
...
### 19. Course Number cannot be M810015 or M810016
Course Number cannot be = M810015 (Insurance Claims Adjustor) or M810016 (Insurance Customer Service Representative). These courses are approved only for accredited institutions.
**Result:** Record rejected
...
### 22. Facility Type must not equal 20 for standard schools *(Updated 07/01/2026)*
If District Number, Current Instruction/Service is not 71 and if School Number, Current Instruction/Service is not 7001, 7004, 7006, or 7023 and if not a Virtual Charter School (Virtual Charter Schools are identified on MSID by Charter School Status not "Z" and School Function Setting equal to "V") then Facility Type must not equal 20.
**Result:** Record rejected
...
### 23. Facility Type must equal 20 for District 71 or Virtual Charter Schools
...
### 40. School Number, Current Instruction/Service must be active on Master School Identification File
...
### 42. Period Number digit-range structure
...
### 43. Florida Education Identifier format
...
### 61. Florida Educators Certificate Number range *(Updated 03/13/2026)*
